...
import sty from "./PlasmicButton.module.css"; // plasmic-import: i2u7Uturkgt/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: A08-LHJjwFT/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: 8dLtbwyM_Be/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__fgZ)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__aB8WW)}
                role={"img"}
              />
            ),
